...
class DatabaseIntrospection(BaseDatabaseIntrospection):
    ...
    def get_table_list(self, cursor):
        ...
        """
        sql  = f"SELECT TABLE_NAME, TABLE_TYPE FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = {get_schema_name()} UNION SELECT CONCAT(TABLE_SCHEMA, '].[', TABLE_NAME) AS TABLE_NAME, TABLE_TYPE FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA != {get_schema_name()};"
        cursor.execute(sql)
